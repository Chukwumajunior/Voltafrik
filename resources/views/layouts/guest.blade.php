                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul>
                                <li class="dropdown">
                                    <a href="#"><span>Services</span> <i class="bi bi-chevron-right"></i></a>
                                    <ul>
                                        <li><a href="{{ route('consultancy') }}">Consultancy</a></li>
                                        <li><a href="{{ route('smart-energy') }}">Smart Energy</a></li>
                                        <li><a href="{{ route('smart-house') }}">Smart House</a></li>
                        ...
                        @endif
                        @if(!Auth::check())
                            <li><a class="getstarted" href="{{ route('register') }}">Create account</a></li>
                        @endif
                        @if(Auth::check())
