            ...
            <div class="col-12 pt-2">
                ...
                <div class="border rounded mt-5 pl-4 pr-4 pt-4 pb-4">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="control-group col-12 mt-2">
                            <div class="form-group mb-3">KINDLY INDICATE TYPE
                                <select class="block mt-1 w-full border-gray-300 rounded-md" type="text" name="category" :value="old('category')" required>
                                    <option value="Tech"  selected>Information</option>
                                    <option value="Fashion"  selected>Market: displays on the store</option>
                                </select>
                            </div>
                        </div>
                    </form>
